const brouwers = [
  ...
  },
  {
    ...
    locatie: "machines",
    description:
      "Ja, ook in Zweden kunnen ze bier brouwen. De Poppels Brouwerij ligt in Jonsered, een buitenwijk van Göteborg in Zweden, één van Europa’s hotspots op biergebied. Ze brouwen hun bier volledig biologisch. Wij houden van Poppels voor hun lekkere hoppige bieren met duidelijke signatuur",
    beers: [],
  },
  {
    number: 20,
  ...
  },
  {
    ...
    locatie: "ZwarteZaal",
    description:
      "Brasserie De La Sambre bevindt zich in Spy, in een prachtige meer dan 800 jaar oude hoeve. Het is een prachtige en inspirerende plek waar ze zowel moderne bieren als traditionele Waalse bieren brouwen. Let op het prachtige logo dat perfect match met de locatie van The Beer Experience.",
    beers: [],
  },
  {
    number: 34,
